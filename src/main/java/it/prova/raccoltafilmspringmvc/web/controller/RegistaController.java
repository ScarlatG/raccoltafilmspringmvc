...
public class RegistaController {
	...
	public String prepareDelete(@PathVariable(required = true) Long idRegista, RedirectAttributes redirectAttrs,
			Model model) {
		Regista temp = registaService.caricaSingoloElementoConFilms(idRegista);
		if (!temp.getFilms().isEmpty()) {
			redirectAttrs.addFlashAttribute("errorMessage",
					"Impossibile rimuovere il regista, ci sono ancora suoi film");
			return "redirect:/regista";
		}
