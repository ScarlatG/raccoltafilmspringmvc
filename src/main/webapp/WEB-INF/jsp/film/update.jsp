					...
					<form:form method="post" modelAttribute="toUpdate_film_attr"
						...
						<div class="col-md-6">
							...
							<spring:bind path="titolo">
								<input type="text" name="titolo" id="titolo"
									...
									value="${toUpdate_film_attr.titolo }">
							</spring:bind>
						...
						<div class="col-md-6">
							...
							<spring:bind path="genere">
								<input type="text" name="genere" id="genere"
									...
									value="${toUpdate_film_attr.genere }">
							</spring:bind>
						...
						<div class="col-md-6">
							<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date'
								value='${toUpdate_film_attr.dataPubblicazione}' />
						...
						<div class="col-md-6">
							...
							<spring:bind path="minutiDurata">
								<input type="number"
									...
									value="${toUpdate_film_attr.minutiDurata }">
							</spring:bind>
						...
						<div class="col-md-6">
							...
							<spring:bind path="regista">
								<input class="form-control ${status.error ? 'is-invalid' : ''}"
									...
									value="${toUpdate_film_attr.regista.nome}${empty toUpdate_film_attr.regista.nome?'':' '}${toUpdate_film_attr.regista.cognome}">
							</spring:bind>
							<input type="hidden" name="regista.id" id="registaId"
								value="${toUpdate_film_attr.regista.id}">
